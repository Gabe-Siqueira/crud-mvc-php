...
<main class="main">
    <section class="jumbotron text-center" style="margin: 0px;">
        <div class="container">
            <h1 class="jumbotron-heading">Atualizar Produto - ID <?=$id?></h1>
            <p>
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-12">
                <?=$message?>
                <!-- INCIO CARD ATUALIZAR PRODUCT -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="http://localhost:8080/product/update/<?=$id?>" method="post">
                                    <div class="product">
                                        <div class="row ml-1">
                                            <h4 class="bold">
                                                Dados
