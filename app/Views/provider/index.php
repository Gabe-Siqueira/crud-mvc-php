    ...
    $result .=  "<tr class='table-active' id='".$value['id']."'>
                    ...
                    <td class='text-center' >
                        <div class='row' style='display: inline-flex;'>
                            <a class='btn btn-primary btn-sm mr-1' href='http://localhost:8080/provider/edit/".$value['id']."' role='button'>
                                Editar <i class='fa fa-pencil-square-o' aria-hidden='true'></i>
                            </a>
                            <a class='btn btn-danger btn-sm' href='http://localhost:8080/provider/delete/".$value['id']."' role='button'>
...
<main class="main">
    <section class="jumbotron text-center" style="margin: 0px;">
        <div class="container">
            <h1 class="jumbotron-heading">Fornecedor</h1>
            <p>
                <a href="http://localhost:8080/home/index" class="btn btn-secondary my-2">Voltar</a>
                <a href="http://localhost:8080/provider/create" class="btn btn-success my-2">Cadastrar</a>    
            </p>
        </div>
    </section>
